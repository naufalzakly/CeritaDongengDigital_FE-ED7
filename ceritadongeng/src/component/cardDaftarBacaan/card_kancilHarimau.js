        ...
        return (
          <Col key={id}>
            <Card className="no-outline">
              <img
                src="https://firebasestorage.googleapis.com/v0/b/cerita-dongeng-digital.appspot.com/o/kancil_harimau%2Fkancil_harimau_1.png?alt=media&token=5c4f0144-6f8e-440e-a6dd-061fa6ed3afd"
                width="400"
                alt="pict"
              />
              <Card.Body>
