        ...
        <Dropdown>
          ...
          <Dropdown.Menu className="dropdown-menu">
            <ul className="dropdown-list">
              ...
              <li className="dropdown-item"><Link to="/">{user && user.email}</Link></li>
              ...
              {login 
                ...
                : <li className="dropdown-item"> <Button variant = "primary"onClick={handleLogIn}> LogIN</Button></li> }
              {login 
                ? <li className="dropdown-item"><Button variant = "danger"onClick={handleLogout}>LogOut</Button></li>
                : null }
