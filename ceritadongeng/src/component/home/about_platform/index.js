    ...
    <div className="about-platform">
      <Container>
        ...
        <Row>
          <Col md="8">
            <p className="mx-2">
              OEPPAK Dongeng adalah paltform untuk membaca cerita dongeng digital dilengkapi dengan
              audio untuk memberikan rangsangan minat kesukaan anak terhadap buku dan memicu rasa
              ingin tahu anak...
            </p>
            <div className="link-pilihan">
              <Link to="">
                {' '}
                <Button size="sm" className="mx-2" variant="light">
                  Lanjutkan Baca{' '}
                </Button>{' '}
              </Link>
          ...
          <Col md="4">
            <div>
              {Platform.filter((platform) => platform.index === 1).map((platform, id) => {
                return (
                  <div key={id}>
